...
class _OtpState extends State<Otp> with SingleTickerProviderStateMixin {
  ...
  get _getInputPart {
    return new Column(
      ...
      children: <Widget>[
        isFilled ? _getEmailLabel("Повторите код доступа") : _getEmailLabel("Придумайте код доступа"),
  ...
  void _setCurrentDigit(int i) {
    setState(() {
      ...
      if (_firstDigit == null) {
        ...
        var current_pin = _firstDigit.toString() +
            _secondDigit.toString() +
            _thirdDigit.toString() +
            _fourthDigit.toString();

//        normal checking needed
        if (current_pin.length == 4 && !isFilled) {
          isFilled = true;
          _oldPin = current_pin;
          current_pin = '';
          clearOtp();
        } else if(_oldPin == current_pin){
